...
4. **拼贴**：从编辑器底部贴纸栏加入页面。选中后可以直接拖动；右下角旋转把手支持拖到任意角度，键盘左右方向键可作 1° 微调（`Shift` 为 15°）。文字可调整字体、颜色和字重。胶带支持纯色、单个 Emoji 或预设 Icon 沿长度重复，Icon 可选线形或面形；左右控制点只改变长度，已有胶带可重新定制底色和图案。
